...
contract buyERC20ByNativeETH is BaseSetup {
    ...
    function testBuyERC20ByNativeETH() public {
        ...
        _snapMarket("buy_erc20_by_NativeETH_first");
    ...
    function testBuyERC20ByNativeETH_consecutive() public {
        ...
        _warpToFreshRunSlot();
        _buyBtcWithEth(users[1], SWAP_IN, 1, address(0));
        _snapMarket("buy_erc20_by_NativeETH_second");
        vm.stopPrank();
    }
    ...
    function testBuyERC20ByNativeETHWithRefer() public {
        ...
        _snapMarket("buy_erc20_by_NativeETH_first_with_refer");

        _warpToFreshRunSlot();
        _buyBtcWithEth(users[1], SWAP_IN, 1, referral);
        _snapMarket("buy_erc20_by_NativeETH_second_with_exists_refer_reject_add");

        _warpToFreshRunSlot();
        _buyBtcWithEth(users[1], SWAP_IN, 1, address(0));
        _snapMarket("buy_erc20_by_NativeETH_second_with_exists_refer");
        vm.stopPrank();
    }
    ...
    function testBuyERC20ByNativeETH_revert_sameGood() public {
        ...
        _snapMarket("testBuyERC20ByNativeETH_revert_sameGood");
        vm.stopPrank();
    }
    ...
    function testBuyERC20ByNativeETH_revert_slippage() public {
        ...
        _snapMarket("testBuyERC20ByNativeETH_revert_slippage");
        vm.stopPrank();
    }
    ...
    function testBuyERC20ByNativeETH_revert_traderMismatch() public {
        ...
        _snapMarket("testBuyERC20ByNativeETH_revert_traderMismatch");
        vm.stopPrank();
    }
