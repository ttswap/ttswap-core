...
contract payERC20ByNativeETH is BaseSetup {
    ...
    function initmetagood() public {
        ...
        market.initMetaGood{value: 50000 * 10 ** 6}(address(1), toTTSwapUINT256(50000 * 10 ** 6, 50000 * 10 ** 6), _goodconfig, defaultdata);
        metagood = address(1);
        vm.stopPrank();
    }
    ...
    function initbtcgood() public {
        ...
        deal( users[1], 50000000 * 10 ** 6);
        
        assertEq(address(market).balance, 50000 * 10 ** 6, "befor init erc20 good, balance of market error");
    ...
    function testPayERC20NormalGood() public {
        ...
        assertEq(
            users[1].balance, 49937000000000, "before pay erc20_normalgood:usdt users[1] account  balance error"
        );
        assertEq(
        ...
        market.buyGood{value: 6300 * 10 ** 6}(metagood, normalgoodbtc, toTTSwapUINT256(6300 * 10 ** 6,1*10**6), 0, users[1], defaultdata);
        ...
        market.buyGood{value: 16300 * 10 ** 6}(metagood, normalgoodbtc, toTTSwapUINT256(16300 * 10 ** 6,1*10**6), 0, users[1], defaultdata);
    ...
    function testPayERC20NormalGoodToOtherUser() public {
        ...
        market.buyGood{value: 6300 * 10 ** 6}(metagood, normalgoodbtc, toTTSwapUINT256(6300 * 10 ** 6,1*10**6), 0, address(100), defaultdata);
        ...
        market.buyGood{value: 16300 * 10 ** 6}(metagood, normalgoodbtc, toTTSwapUINT256(16300 * 10 ** 6,1*10**6), 0, address(100), defaultdata);
