...
contract payERC20ByNativeETH is BaseSetup {
    ...
    function testPayERC20ByNativeETH() public {
        ...
        assertEq(
            ...
            900000000,
            "before pay erc20_normalgood:btc users[1] account  balance error"
        );
        assertEq(
            users[1].balance,
            49937000000000,
            "before pay erc20_normalgood:usdt users[1] account  balance error"
        );
        assertEq(
            address(market).balance,
            113000000000,
        ...
        assertEq(
            normalgoodkeystate.currentState.amount0(),
            toTTSwapUINT256(100000500, 99000000).amount0(),
            "after pay erc20 normalgood:normalgoodkey currentState error"
        );

        assertEq(
            normalgoodkeystate.currentState.amount1(),
            toTTSwapUINT256(100000500, 99000000).amount1(),
