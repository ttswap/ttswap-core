...
contract buyNativeETHByERC20 is BaseSetup {
    ...
    function testBuyNativeETHGood() public {
        ...
        assertEq(
            usdt.balanceOf(users[1]), 49937000000000, "before buy NativeETH_normalgood:usdt users[1] account  balance error"
        );
        assertEq(
        ...
        assertEq(
            ...
            "before  buy NativeETH  normalgood:metagoodkey investState error"
        );
        assertEq(
        ...
        assertEq(
            ...
            "before  buy NativeETH  normalgood:normalgoodkey investState error"
        );
        assertEq(
        ...
        assertEq(
            ...
            "after  buy NativeETH  normalgood:metagoodkey investState error"
        );
        assertEq(
            metagoodkeystate.investState.amount1(),
            toTTSwapUINT256(
        ...
        assertEq(
            ...
            "after  buy NativeETH  normalgood:normalgoodkey investState error"
        );
        assertEq(
            normalgoodkeystate.investState.amount1(),
            toTTSwapUINT256(
        ...
        function testBuyNativeETHGoodWithRefer() public {
        vm.startPrank(users[1]);
        usdt.approve(address(market), 800000 * 10 ** 6 + 1);
