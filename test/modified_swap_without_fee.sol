...
contract modified_swap is Test, GasSnapshot  {
    ...
    function testswapwithoutfee()public{
        ...
        market.buyGood(address(usdc),address(usdt),toTTSwapUINT256(10000*10**6,1000*10**6),1,address(0),"");
        ...
        market.buyGood(address(usdt),address(usdc),toTTSwapUINT256(7142857142,9000000000),1,msg.sender,"");
    ...
    function testpaywithoutfee()public{
        ...
        S_GoodTmpState memory beforeusdc=market.getGoodState(address(usdc));
        S_GoodTmpState memory beforeusdt=market.getGoodState(address(usdt));
        market.buyGood(address(usdt),address(usdc),toTTSwapUINT256(10000*10**6,1000*10**6),0,marketcreator,"");
        ...
        console2.log("usdtafter:",usdtafter);
        usdc.approve(address(market), 50000 * 10 ** 6 + 1);
        market.buyGood(address(usdc),address(usdt),toTTSwapUINT256(10000*10**6,1041666666),0,marketcreator,"");
